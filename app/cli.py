...
def _build_parser() -> argparse.ArgumentParser:
    ...
    pdf_zmk2_full.add_argument("--input-dir", required=True)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        tool_name = args.tool if hasattr(args, "tool") else "pdf-zmk"
        print(
            "\n╔══════════════════════════════════════════════════╗\n"
            "║  AGENT_READ_REQUIRED                             ║\n"
            "╚══════════════════════════════════════════════════╝\n",
        ...
        print(
            ...
            f"→ Then re-run: python -m app.cli {tool_name} full --input-dir <dir> --sheet-write\n",
            file=sys.stderr,
        )
